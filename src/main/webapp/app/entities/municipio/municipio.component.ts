...
export class MunicipioComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.municipioService
            ...
            .subscribe(
                (res: HttpResponse<IMunicipio[]>) => this.paginateMunicipios(res.body, res.headers),
    ...
    trackId(index: number, item: IMunicipio) {
        return item.id;
    }
    ...
    private paginateMunicipios(data: IMunicipio[], headers: HttpHeaders) {
