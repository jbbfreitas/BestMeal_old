...
import { NomeComponent } from 'app/entities/nome/nome.component';
import { NomeService } from 'app/entities/nome/nome.service';
import { Nome } from 'app/shared/model/nome.model';

describe('Component Tests', () => {
    describe('Nome Management Component', () => {
        let comp: NomeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(NomeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.nomes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
