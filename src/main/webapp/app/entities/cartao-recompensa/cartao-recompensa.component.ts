...
@Component({
    selector: 'jhi-cartao-recompensa',
    templateUrl: './cartao-recompensa.component.html'
})
export class CartaoRecompensaComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/cartao-recompensa'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    ngOnInit() {
        ...
        this.registerChangeInCartaoRecompensas();
    }
    ...
    trackId(index: number, item: ICartaoRecompensa) {
        return item.id;
    }

    registerChangeInCartaoRecompensas() {
    ...
    private paginateCartaoRecompensas(data: ICartaoRecompensa[], headers: HttpHeaders) {
