...
import { LogradouroComponent } from 'app/entities/logradouro/logradouro.component';
...
describe('Component Tests', () => {
    describe('Logradouro Management Component', () => {
        let comp: LogradouroComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LogradouroComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.logradouros[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
